...
--
-- Servidor: localhost
-- Tiempo de generación: 30-04-2018 a las 04:12:10
...
(3000000, 'sexto', 'matutino', 's', 3000101, 3000713);
...
(1252601, '1002600', 'Sección_6', 'images/', 'pruebaaaa', 'qwe', 'qwe', 'qwe', 'qwe'),
(1682603, '1002600', 'Sección_6', 'images/', 'pruebaaaaaaaaaaaaaaaaaaaa', 'qwe', 'qwe', 'qwe', 'qw'),
(1811701, '1001700', 'Sección_7', 'images/', 'pruebaaa3', 'asd', 'q', 'asd', 'asd'),
(1842602, '1002600', 'Sección_6', 'images/', 'prueba2', 'qw', 'q', 'q', 'w'),
(2851801, '2001800', 'Sección_8', 'images/', 'nueva pregunta de pruebaaaa', 'sda', 'eqw', 'qwe', 'asd'),
...
(3851901, '3001900', 'Sección_9', 'images/', 'pregunta1111111', 'asd', 'a', 'a|', '|as'),
(18321111, '10021100', 'Sección_11', 'images/', 'mas pruebas', 'sdf', 's', 'v', 'SDF');
...
('12040691', '3000201', 'b', 'Los pescadores evitan la fatiga y sólo trabajan mediodía'),
('12040691', '3000204', 'd', 'Un esquimal'),
('12040691', '3000202', 'c', 'Tercera persona'),
('12040691', '3000203', 'a', 'Los modificadores'),
('12040691', '3000302', 'a', 'El mundo de la web no sólo se utiliza para el ocio, sino para adquirir conocimientos muy útiles para todos'),
('12040691', '3000301', 'a', 'Internet se está convirtiendo en el <<medio de comunicación global>>, debido a que es una herramienta indispensable para la educación, el conocimiento y el disfrute. Sin embargo, este último uso lo puede volver negativo, puesto que se abusa de él. Como conclusión, Internet puede causar adicción, con consecuencias tales como la pérdida de una vida social activa.'),
('12040691', '3000405', 'a', 'Efectos positivos de los conciertos para disminuir el estrés'),
('12040691', '3000401', 'c', 'La reducción del estrés a partir de escuchar música en vivo.'),
('12040691', '3000402', 'c', 'Las consecuencias de escuchar música voluntariamente'),
('12040691', '3000502', 'b', 'Un golfista'),
('12040691', '3000510', 'b', 'Se pone de manifiesto la presencia del autor en lo narrado. Con esta forma de enunciación, se consigue atrapar con mayor fuerza la atención del receptor, aumenta su interés, pues lo que el enunciador dice tiene apariencia de algo que ha vivido, que ha experimentado de manera personal.'),
('12040691', '3000501', 'a', 'Los modificadores');
...
(1001700, 'Sección_7', 3, 1811701),
(1002600, 'Sección_6', 4, 1682603),
(2001800, 'Sección_8', 3, 2851801),
(3000200, 'Sección_2', 4, 3000204),
(3000300, 'Sección_3', 2, 3000302),
(3000400, 'Sección_4', 3, 3000405),
(3000500, 'Sección_5', 3, 3000513),
(3001900, 'Sección_9', 1, 3851901),
(10011000, 'Sección_10', 3, 10011000),
(10021100, 'Sección_11', 2, 18321111);
